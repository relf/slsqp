...
unsafe extern "C" fn dnrm2___(
    ...
    i = 0 as ::core::ffi::c_int;
    while i < n {
        let mut xabs: ::core::ffi::c_double = fabs(*dx.offset((incx * i) as isize));
        if xmax < xabs {
            xmax = xabs;
        }
        i += 1;
...
unsafe extern "C" fn dsrotg_(
    ...
    if scale != 0 as ::core::ffi::c_int as ::core::ffi::c_double {
        ...
        let mut iscale: ::core::ffi::c_double =
            1 as ::core::ffi::c_int as ::core::ffi::c_double / scale;
        ...
        *s = *db / r;
        *da = r;
        if *c != 0 as ::core::ffi::c_int as ::core::ffi::c_double && fabs(*c) <= *s {
        ...
        match current_block {
            ...
            _ => {
                if !(*ncv <= 0 as ::core::ffi::c_int) {
                    ...
                    if !(b >= 0.0f64) {
                        b = one / b;
                        i2 = 1 as ::core::ffi::c_int - *icv
                            + *ice * (*lpivot - 1 as ::core::ffi::c_int);
                        incr = *ice * (*l1 - *lpivot);
                        i__1 = *ncv;
                        ...
                        while j <= i__1 {
                            ...
                            if !(sm == 0.0f64) {
                                ...
                                *c__.offset(i2 as isize) += sm * *up;
                                ...
                                i__ = *l1;
                                while i__ <= i__2 {
                                    *c__.offset(i4 as isize) += sm
                                        * *u.offset(
                                            (i__ * u_dim1 + 1 as ::core::ffi::c_int) as isize,
                                        );
                                    i4 += *ice;
                                    i__ += 1;
                                }
                    ...
                    *x.offset(i__ as isize) = 0.0f64;
                    ...
                    while j <= i__2 {
                        ...
                        *indx.offset((j - 1 as ::core::ffi::c_int) as isize) = ii;
                        dsrotg_(
                            a.offset((j - 1 as ::core::ffi::c_int + ii * a_dim1) as isize)
                                as *mut ::core::ffi::c_double,
                            a.offset((j + ii * a_dim1) as isize) as *mut ::core::ffi::c_double,
                            &raw mut c__,
                            &raw mut s,
                        );
...
pub unsafe extern "C" fn nlopt_slsqp(
    ...
    if ptot > n {
        nlopt_stop_msg(
            stop,
            b"slsqp: more equality constraints than variables\0" as *const u8
        ...
        (::core::mem::size_of::<::core::ffi::c_double>() as size_t)
            .wrapping_mul(
                (mpi1 as ::core::ffi::c_uint)
                    .wrapping_mul(n.wrapping_add(1 as ::core::ffi::c_uint))
                    ...
                    .wrapping_add(len_w as ::core::ffi::c_uint) as size_t,
            )
            .wrapping_add(
                (::core::mem::size_of::<::core::ffi::c_int>() as size_t)
                    .wrapping_mul(len_jw as ::core::ffi::c_uint as size_t),
            ),
    ) as *mut ::core::ffi::c_double;
    if work.is_null() {
    ...
    '_eval_f_and_grad: loop {
                    ...
                    while i < p {
                        ...
                        if nlopt_stop_forced(stop) != 0 {
                            ...
                            while k < (*h.offset(i as isize)).m {
                                infeasibility_cur =
                                    if infeasibility_cur >= fabs(*c.offset(ii as isize)) {
                                        infeasibility_cur
                                    } else {
                                        fabs(*c.offset(ii as isize))
                                    };
                ...
                loop {
                    ...
                    match mode {
                        ...
                        2 | _ => {
                            nlopt_stop_msg(
                                stop,
                                b"bug: workspace is too small\0" as *const u8
                                    as *const ::core::ffi::c_char,
                            );
        ...
        match current_block {
            ...
            _ => {
                nlopt_stop_msg(
                    stop,
                    b"bug: more than iter SQP iterations\0" as *const u8
                        as *const ::core::ffi::c_char,
                );
                ret = NLOPT_FAILURE;
                break;
